...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "D:/programs/Xlinx/Vitis/Vitis_HLS/2022.1/common/technology/autopilot\\etc/autopilot_ssdm_op.h" 1
# 154 "D:/programs/Xlinx/Vitis/Vitis_HLS/2022.1/common/technology/autopilot\\etc/autopilot_ssdm_op.h"
extern "C" {
...
# 1 "./example.h" 1
# 16 "./example.h"
# 1 "D:/programs/Xlinx/Vitis/Vitis_HLS/2022.1/common/technology/autopilot\\hls_stream.h" 1
# 61 "D:/programs/Xlinx/Vitis/Vitis_HLS/2022.1/common/technology/autopilot\\hls_stream.h"
# 1 "D:/programs/Xlinx/Vitis/Vitis_HLS/2022.1/common/technology/autopilot/hls_stream_39.h" 1
# 72 "D:/programs/Xlinx/Vitis/Vitis_HLS/2022.1/common/technology/autopilot/hls_stream_39.h"
namespace hls {
# 94 "D:/programs/Xlinx/Vitis/Vitis_HLS/2022.1/common/technology/autopilot/hls_stream_39.h"
...
# 62 "D:/programs/Xlinx/Vitis/Vitis_HLS/2022.1/common/technology/autopilot\\hls_stream.h" 2
# 17 "./example.h" 2
...
__attribute__((sdx_kernel("example", 0))) void example(hls::stream<int>& A, hls::stream<int>& B){
#line 14 "D:/programs/Xlinx/2022_HLS_Projects/Lab_Vitis/Lab_A/deadlock/proj/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=example
# 18 "example.cpp"

#line 6 "D:/programs/Xlinx/2022_HLS_Projects/Lab_Vitis/Lab_A/deadlock/proj/solution1/directives.tcl"
#pragma HLSDIRECTIVE TOP name=example
# 18 "example.cpp"
...
#pragma HLS STREAM depth=2 variable=data_channel2
...
void proc_1_1(hls::stream<int>& A, hls::stream<int>& data_channel1, hls::stream<int>& data_channel2){
  int i;
  int tmp;
  VITIS_LOOP_47_1: for(i = 0; i < 10; i++){
    tmp = A.read();
    data_channel1.write(tmp);
  }
  VITIS_LOOP_51_2: for(i = 0; i < 10; i++){
...
void proc_1_2(hls::stream<int>& B, hls::stream<int>& C, hls::stream<int>& data_channel1, hls::stream<int>& data_channel2){
  ...
  VITIS_LOOP_60_1: for(i = 0; i < 10; i++){
    tmp = data_channel2.read() + data_channel1.read();
    B.write(tmp);
  }
  VITIS_LOOP_64_2: for(i = 0; i < 10; i++){
    C.write(tmp);
  }
}
...
void proc_2_1(hls::stream<int>& A, hls::stream<int>& B, hls::stream<int>& data_channel1, hls::stream<int>& data_channel2){
  int i;
  int tmp;
  VITIS_LOOP_84_1: for(i = 0; i < 10; i++){
    tmp = A.read() + B.read();
    data_channel1.write(tmp);
  }
  VITIS_LOOP_88_2: for(i = 0; i < 10; i++){
    data_channel2.write(tmp);
  }
}
...
void proc_2_2(hls::stream<int>& C, hls::stream<int>& data_channel1, hls::stream<int>& data_channel2){
  int i;
  int tmp;
  VITIS_LOOP_96_1: for(i = 0; i < 10; i++){
    tmp = data_channel2.read() + data_channel1.read();
    C.write(tmp);
  }
}
